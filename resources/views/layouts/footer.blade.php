                ...
                <div class="col-lg-5">
                    ...
                    <div class="single-contact row">      
                        <div class="content-footer col-12 col-lg-9">
                            <a href="/" class="name-company">MovieLand</a> - Trang xem phim Online với giao diện
                            mới được bố trí và
                            thiết kế thân thiện với người dùng.
                            Nguồn phim được tổng hợp từ các website lớn với đa dạng các đầu phim và thể loại vô cùng
                            phong phú.
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <ul class="list-menu dropdown-footer1 toggle-mn">
                                ...
                                <li class="li_menu">
                                    <a class="link" href="/" title="Phim mới">Phim Mới</a>
                                </li>

                                <li class="li_menu">
                                    <a class="link" href="/" title="Phim Nổi Bật">Phim Nổi Bật</a>
                                </li>

                                <li class="li_menu">
                                    <a class="link" href="/" title="Phim Bộ">Phim Bộ</a>
                                </li>

                                <li class="li_menu">
                                    <a class="link" href="/" title="Phim Lẻ">Phim Lẻ</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-4">
                            ...
                            <ul class="list-menu dropdown-footer2 toggle-mn">
                                <li class="li_menu">
                                    <a class="link" href="/" title="Phim Cổ Trang">Phim Cổ Trang</a>
                                </li>

                                <li class="li_menu">
                                    <a class="link" href="/" title="Phim Hành Động">Phim Hành Động</a>
                                </li>

                                <li class="li_menu">
                                    <a class="link" href="/" title="Phim Tình Cảm">Phim Tình Cảm</a>
                                </li>

                                <li class="li_menu">
                                    <a class="link" href="/" title="Phim Hoạt Hình">Phim Hoạt Hình</a>
                                </li>

                                <li class="li_menu">
                                    <a class="link" href="/" title="Phim Kinh Dị">Phim Kinh Dị</a>
                                </li>

                                <li class="li_menu">
                                    <a class="link" href="/" title="Tâm Lý">Tâm Lý</a>
                                </li>

                                <li class="li_menu">
                                    <a class="link" href="/" title="Phiêu Lưu">Phiêu Lưu</a>
                                </li>
                            </ul>
                        </div>
