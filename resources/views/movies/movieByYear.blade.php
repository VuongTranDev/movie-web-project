                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            @if ($page > 1)
                                <li class="page-item">
                                    <a class="page-link"
                                        href="{{ route('movie.year', ['slug' => $slug, 'page' => $page - 1]) }}"
                                        aria-label="Previous">
                            ...
                            @if ($startPage > 1)
                                <li class="page-item">
                                    <a class="page-link"
                                        href="{{ route('movie.year', ['slug' => $slug, 'page' => 1]) }}">1</a>
                                </li>
                                @if ($startPage > 2)
                                    <li class="page-item disabled">
                            ...
                            @for ($i = $startPage; $i <= $endPage; $i++)
                                <li class="page-item {{ $i == $page ? 'active' : '' }}">
                                    <a class="page-link"
                                        href="{{ route('movie.year', ['slug' => $slug, 'page' => $i]) }}">
                                        {{ $i }}
                                    </a>
                                </li>
                            @endfor
                            ...
                            @if ($endPage < $totalPages)
                                ...
                                <li class="page-item">
                                    <a class="page-link"
                                        href="{{ route('movie.year', ['slug' => $slug, 'page' => $totalPages]) }}">{{ $totalPages }}</a>
                                </li>
                            @endif
